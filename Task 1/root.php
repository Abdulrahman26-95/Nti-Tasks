                ...
                <div class="col-4 offset-4 mt-5">
                    <form action="" method="POST">
                        <div class="form-group">
                            <input type="number" name="Number" id="ID" class="form-control text-center" placeholder="Enter The Number" aris-describedby="helpId">
                        </div>
                        <div class="form-group">
                            <input type="number" name="Root" id="ID" class="form-control text-center" placeholder="ٌRoot" aris-describedby="helpId">
                        </div>
                        <div class="form-group">
